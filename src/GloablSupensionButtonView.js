...
export default class GloablSupensionButtonView extends Component {
    ...
    static addMenuButton(button,index=-1){

        instance.addMenuButton(button,index);
    }
    ...
    static removeMenuButton(index){
        ...
        instance.removeMenuButton(index)
    }
    ...
    static replaceMenuButton(buttonArr){
        ...
        instance.replaceMenuButton(buttonArr)
    }
    ...
    static onClickButton(cb){

        clickButtonCb = cb;
    }

    static onRemoveButton(cb){
            ...
            <WindowView
                ...
                onClickButton={(index,data,isEdit)=>{
                    ...
                    if (isEdit === true){
                        ...
                        if (removeButtonCb !== null){

                            removeButtonCb(index,data)
                        }
                    }else {
